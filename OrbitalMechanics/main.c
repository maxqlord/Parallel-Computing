...
int * moon_location(int time, int* xy) {
    xy[0] = (int)(r*sin(time * (3.14159265/180.0)));
    xy[1] = (int)(r*cos(time * (3.14159265/180.0)));
    return xy;
}
...
int main() {
    ...
    double velocity = 12000; //meters/second //7800 for circular   //12000 for hyperbola
    ...
    y[0] = (int)(R + altitude);
    double angle = 90.0;
    vx[0] = velocity * sin(angle * (3.14159265/180.0));
    vy[0] = velocity * cos(angle * (3.14159265/180.0));
    printf("%f\t%f\n", vx[0], vy[0]);
    v[0] = velocity;
    rm[0] = r;
